export default function StepsNav() {
	return (
		<div className="z-10 mt-8 flex justify-center md:m-4 md:mt-4 md:w-full md:justify-start md:rounded-xl md:bg-[url('/src/assets/images/Container.jpg')] md:bg-cover md:bg-center md:bg-no-repeat md:px-6 md:py-10">
			<nav>
